...
You can play with the grid posisitions and the Scene size (now set to 600,400). E.g. What happens if you don't set it?
You can see the grid lines by uncommenting the line ` //grid.setGridLinesVisible(true);       // nice if you want to check the grid layout`
